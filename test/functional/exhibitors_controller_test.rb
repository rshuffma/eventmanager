...
class ExhibitorsControllerTest < ActionController::TestCase
  ...
  test "should create exhibitor" do
    assert_difference('Exhibitor.count') do
      post :create, exhibitor: { description: @exhibitor.description, exhibitor_category_id: @exhibitor.exhibitor_category_id, name: @exhibitor.name }
    end
  ...
  test "should update exhibitor" do
    put :update, id: @exhibitor, exhibitor: { description: @exhibitor.description, exhibitor_category_id: @exhibitor.exhibitor_category_id, name: @exhibitor.name }
    assert_redirected_to exhibitor_path(assigns(:exhibitor))
  end
